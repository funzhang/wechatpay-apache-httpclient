...
public class WechatPay2Credentials implements Credentials {
  ...
  protected String buildMessage(String nonce, long timestamp, HttpRequestWrapper request)
      throws IOException {
    ...
    if (request.getOriginal() instanceof WechatPayUploadHttpPost) {
      ...
      body = EntityUtils.toString(((HttpEntityEnclosingRequest) request).getEntity(), "utf-8");
    }
